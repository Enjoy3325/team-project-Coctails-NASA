 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var qs,js;function Hs(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vs{operationForChild(e){return Uo(this.path)?new Vs(this.source,Ro()):new Vs(this.source,Oo(this.path))}constructor(e,t){this.source=e,this.path=t,this.type=qs.LISTEN_COMPLETE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xs{operationForChild(e){return Uo(this.path)?new Xs(this.source,Ro(),this.snap.getImmediateChild(e)):new Xs(this.source,Oo(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=qs.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ks{operationForChild(e){if(Uo(this.path)){const t=this.children.subtree(new So(e));return t.isEmpty()?null:t.value?new Xs(this.source,Ro(),t.value):new Ks(this.source,Ro(),t)}return jn(Lo(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Ks(this.source,Oo(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=qs.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oa(e,t,n,i,r){const o=new Ra;let s,a;if(n.type===qs.OVERWRITE){const l=n;l.source.fromUser?s=Da(e,t,l.path,l.snap,i,r,o):(jn(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered()&&!Uo(l.path),s=Ma(e,t,l.path,l.snap,i,r,a,o))}else if(n.type===qs.MERGE){const l=n;l.source.fromUser?s=function(e,t,n,i,r,o,s){let a=t;return i.foreach(((i,l)=>{const c=Fo(n,i);Fa(t,Lo(c))&&(a=Da(e,a,c,l,r,o,s))})),i.foreach(((i,l)=>{const c=Fo(n,i);Fa(t,Lo(c))||(a=Da(e,a,c,l,r,o,s))})),a}(e,t,l.path,l.children,i,r,o):(jn(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered(),s=Ba(e,t,l.path,l.children,i,r,a,o))}else if(n.type===qs.ACK_USER_WRITE){const a=n;s=a.revert?function(e,t,n,i,r,o){let s;if(null!=Ia(i,n))return t;{const a=new Aa(i,t,r),l=t.eventCache.getNode();let c;if(Uo(n)||".priority"===Lo(n)){let n;if(t.serverCache.isFullyInitialized())n=xa(i,na(t));else{const e=t.serverCache.getNode();jn(e instanceof _s,"serverChildren would be complete if leaf node"),n=ka(i,e)}c=e.filter.updateFullNode(l,n,o)}else{const r=Lo(n);let u=Ta(i,r,t.serverCache);null==u&&t.serverCache.isCompleteForChild(r)&&(u=l.getImmediateChild(r)),c=null!=u?e.filter.updateChild(l,r,u,Oo(n),a,o):t.eventCache.getNode().hasChild(r)?e.filter.updateChild(l,r,_s.EMPTY_NODE,Oo(n),a,o):l,c.isEmpty()&&t.serverCache.isFullyInitialized()&&(s=xa(i,na(t)),s.isLeafNode()&&(c=e.filter.updateFullNode(c,s,o)))}return s=t.serverCache.isFullyInitialized()||null!=Ia(i,Ro()),Zs(t,c,s,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class ec{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function tc(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],o=r.getPath();null===n||Wo(o,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:o}),n.events.push(r)}n&&e.eventLists_.push(n)}function nc(e,t,n){tc(e,n),ic(e,(e=>qo(e,t)||qo(t,e)))}function ic(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(rc(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function rc(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();qr&&$r("event: "+n.toString()),so(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Ar="9.13.0",gr(new Di("database",((e,{instanceIdentifier:t})=>qc(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),xr("@firebase/database","0.13.10",e),xr("@firebase/database","0.13.10","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Du(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(zu(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Fu(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(qu(t))return"Blackberry";if(ju(t))return"Webos";if(Uu(t))return"Safari";if((t.includes("chrome/")||Bu(t))&&!t.includes("edge/"))return"Chrome";if(Wu(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Fu(e=Qn()){return/firefox\//i.test(e)}function Uu(e=Qn()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Bu(e=Qn()){return/crios\//i.test(e)}function zu(e=Qn()){return/iemobile/i.test(e)}function Wu(e=Qn()){return/android/i.test(e)}function qu(e=Qn()){return/blackberry/i.test(e)}function ju(e=Qn()){return/webos/i.test(e)}function Hu(e=Qn()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function $u(){return ni()&&10===document.documentMode}function Vu(e=Qn()){return Hu(e)||Wu(e)||ju(e)||qu(e)||/windows phone/i.test(e)||zu(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
